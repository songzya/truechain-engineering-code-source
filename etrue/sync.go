...
func (pm *ProtocolManager) synchronise(peer *peer) {
	...
	log.Info("synchronise  ", "pHead", pHead, "pTd", pTd, "td", td, "fastHeight", fastHeight, "currentFast", currentNumber, "snailNumber", currentBlock.Number(), "snailHash", currentBlock.Hash())
	if pTd.Cmp(td) <= 0 {
